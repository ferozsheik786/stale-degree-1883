    ...
    return(
        <div id="nav" style={{display:"flex", justifyContent:"space-between",
         ...
         background:"black"}}>
            ...
            alt="amazon" style={{height:"45px", width:"120px"}} /></Link>
            ...
            alt="location" style={{height:"25px", width:"20px"}} /> <select name="Location" id="" style={{border:"0",background:"black", color:"grey"}}>
                <option value="selelct">Select</option>
                <option value="Hyderabad">Hyderabad</option>
                <option value="Chennai">Chennai</option>
                <option value="bangaloore">Bangaloore</option>
                <option value=""></option>
                <option value=""></option>
                </select> </Link>
